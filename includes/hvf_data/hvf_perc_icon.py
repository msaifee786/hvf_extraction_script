...
class Hvf_Perc_Icon:
	...
	def initialize_class_vars(cls):
		...
		cls.perc_5_template = cv2.cvtColor(File_Utils.read_image_from_file("includes/hvf_data/perc_icons/perc_5.JPG"), cv2.COLOR_BGR2GRAY);
		cls.perc_2_template = cv2.cvtColor(File_Utils.read_image_from_file("includes/hvf_data/perc_icons/perc_2.JPG"), cv2.COLOR_BGR2GRAY);
		cls.perc_1_template = cv2.cvtColor(File_Utils.read_image_from_file("includes/hvf_data/perc_icons/perc_1.JPG"), cv2.COLOR_BGR2GRAY);
		cls.perc_half_template = cv2.cvtColor(File_Utils.read_image_from_file("includes/hvf_data/perc_icons/perc_half.JPG"), cv2.COLOR_BGR2GRAY);
