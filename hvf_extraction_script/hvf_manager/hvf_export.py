...
class Hvf_Export:
    ...
    def convert_hvf_obj_to_delimited_string(hvf_obj, metadata_key_list, delimiter):
        ...
        if hvf_obj.pat_dev_value_array.is_pattern_not_generated():
            ...
            pdp_vals = Hvf_Export.convert_plot_to_delimited_string(
                hvf_obj.pat_dev_percentile_array, laterality, delimiter
            )
    ...
    def export_hvf_list_to_spreadsheet(dict_of_hvf):
        ...
        for file_name in dict_of_hvf:
            ...
            hvf_obj_line = (
                file_name
                + Hvf_Export.CELL_DELIMITER
                + Hvf_Export.convert_hvf_obj_to_delimited_string(
